...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-tags", "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp-git", "cmp-rg", "cmp-nvim-lua", "cmp-cmdline", "cmp-spell" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-translator', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
