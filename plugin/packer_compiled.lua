...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-git", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp_luasnip", "cmp-spell" },
  ...
  ["nvim-lspconfig"] = {
    after = { "SchemaStore.nvim", "neodev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-live-grep-args.nvim", "nvim-telescope-ctags-plus", "telescope-gtags", "telescope-fzf-native.nvim" },
