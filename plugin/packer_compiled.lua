...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp_luasnip", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-nvim-tags", "cmp-git" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gtags", "nvim-telescope-ctags-plus", "telescope-fzf-native.nvim", "telescope-live-grep-args.nvim" },
