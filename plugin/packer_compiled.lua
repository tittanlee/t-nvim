...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-tags", "cmp-nvim-lsp", "cmp-buffer", "cmp-git", "cmp-cmdline", "cmp-path", "cmp-nvim-lua", "cmp-spell" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-telescope-ctags-plus", "telescope-fzf-native.nvim", "telescope-gtags", "telescope-live-grep-args.nvim" },
