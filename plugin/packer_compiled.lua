...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-spell", "cmp-git", "cmp-cmdline", "cmp-path", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-buffer", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-gtags", "telescope-live-grep-args.nvim", "nvim-telescope-ctags-plus", "telescope-fzf-native.nvim" },
