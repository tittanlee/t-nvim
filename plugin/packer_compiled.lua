...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-cmdline", "cmp-buffer", "cmp-git", "cmp-spell", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-live-grep-args.nvim", "nvim-telescope-ctags-plus", "telescope-fzf-native.nvim", "telescope-gtags" },
