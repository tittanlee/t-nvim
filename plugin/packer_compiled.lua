...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    config = { "\27LJ\2\nB\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0'plugins.tab_line.bufferline.config\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-git", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-rg" },
...
try_loadstring("\27LJ\2\nB\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0'plugins.tab_line.bufferline.config\frequire\0", "config", "bufferline.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
