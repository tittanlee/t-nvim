...
function M.on_term_open(term)
    keymap("t"   , module_key.back_to_normal, [[<C-\><C-n>]]      , {buffer = true, desc = ""})
    -- keymap("t", "jk"                     , [[<C-\><C-n>]]      , {buffer = true, desc = ""})
    keymap("t"   , module_key.mv_win_up     , [[<C-\><C-n><C-W>k]], {buffer = true, desc = ""})
    keymap("t"   , module_key.mv_win_down   , [[<C-\><C-n><C-W>j]], {buffer = true, desc = ""})
    keymap("t"   , module_key.mv_win_left   , [[<C-\><C-n><C-W>h]], {buffer = true, desc = ""})
    keymap("t"   , module_key.mv_win_right  , [[<C-\><C-n><C-W>l]], {buffer = true, desc = ""})
end
